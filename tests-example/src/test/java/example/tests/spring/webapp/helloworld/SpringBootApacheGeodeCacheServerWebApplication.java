...
/**
 * The SpringBootApacheGeodeCacheServerWebApplication class...
 *
 * @author John Blum
 * @since 1.0.0
 */
...
@EnableHttpService
@EnableLocator
@EnableManager(start = true, bindAddress = "localhost")
@RestController
@SuppressWarnings("unused")
public class SpringBootApacheGeodeCacheServerWebApplication {

  public static void main(String[] args) {
    SpringApplication.run(SpringBootApacheGeodeCacheServerWebApplication.class, args);
  }
