...
public class GeodeServerApplication implements Runnable {
  ...
  protected static final int DEFAULT_GEMFIRE_CACHE_SERVER_PORT = CacheServer.DEFAULT_PORT;
  protected static final int DEFAULT_GEMFIRE_JMX_MANAGER_PORT = 1099;

  protected static final String DEFAULT_GEMFIRE_CACHE_SERVER_BIND_ADDRESS = "";
  ...
  public static GeodeServerApplication run(String[] args) {
    GeodeServerApplication peerCacheApplication = newGeodeServerApplication(args);
