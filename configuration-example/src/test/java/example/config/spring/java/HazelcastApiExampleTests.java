...
package example.config.spring.java;
 ...
 * with Spring Data Geode's API (Java-based configuration meta-data).
 *
 * @author John Blum
...
public class HazelcastApiExampleTests {
  ...
  @Resource(name = "myDistributedRegion")
  ...
  @Configuration
  static class HazelcastApiExampleConfiguration {
    ...
    @Bean
    LocalRegionFactoryBean<String, String> myDistributedRegion(GemFireCache gemfireCache) {
